...
4. Clone the repository to your local computer.
    1. Open [Bumby Color Compass GitHub Repo](https://github.com/Bumby-Wool/colorcompass)
...
9. Then you can open [http://localhost:3000/colorcompass/index.html](http://localhost:3000/colorcompass/index.html) in a browser to see the application running
</details>
...
```
cd c:\\WhereIClonedTheRepo\colorcompass\
```
...
npm start
```
This will server all the files in the repo as static files. You can view the main application page at [http://localhost:3000/colorcompass/index.html](http://localhost:3000/colorcompass/index.html)

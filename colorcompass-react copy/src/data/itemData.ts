import type { Item } from "../types/builder";

// Item definitions ported from the legacy Angular data service.
    ...
    variants: [
      {
        ...
        options: [
          ...
          { label: "Body", elements: ["TDCBody_00000091728544352029154250000003918608914771493567_"] },
          {
            label: "Leg Cuffs",
            elements: [
              "TDCLeftCuff_00000183235140444635553040000002557799785209837215_",
              "TDCRightCuff_00000128460512440843210380000002816660742991847597_",
            ],
          },
        ],
        extras: [],
        ...
        extras: [
          {
            ...
            types: [
              {
                label: "Square Cargo Pockets",
                elements: [
                  "SqCrgPcktLeft_00000090974600374340835350000000421229108712511901_",
                  "SqCrgPcktRight_00000183948036079710681590000008296976022486105480_",
                ],
              },
              {
                label: "Purse Pockets",
                elements: [
                  "PrsPcktLeft_00000057146265986560687120000000737081065595376299_",
                  "PrsPcktRight_00000139293710192736616710000015868473601287855806_",
                ],
              },
              {
                label: "Circle Pockets",
                elements: [
                  "LeftRndPocket_00000152963165625522652400000009080140183325640101_",
                  "RightRndPocket_00000083058202902342236950000005102892317602836652_",
                  "LeftRndPocketCuff_00000103230193605404299900000001955532516737887671_",
                  "RightRndPocketCuff_00000155862688109118890200000015694904390342983088_",
                ],
              },
              {
                label: "Heart Pockets",
                elements: [
                  "HrtPcktLeft_00000053511858347973327500000014189635792340543416_",
                  "HrtPcktRight_00000011752062273117927150000014847718233158951607_",
                ],
              },
              {
                label: "Rounded Cargo Pockets",
                elements: [
                  "RndCrgPcktLeft_00000179621803826058076970000013413824110984863364_",
                  "RndCrgPcktRight_00000035530665404003504600000016711561037687271826_",
                ],
              },
              {
                label: "Pockets",
                elements: [
                  "LeftPocket_00000091712150374883887260000010981178920471028864_",
                  "RightPocket_00000124144153490674325130000008645752175170119564_",
                ],
              },
            ],
          },
        ...
        extras: [
          {
            ...
            types: [
              ...
              {
                label: "Circle Pockets",
                elements: ["LeftRndPocket", "RightRndPocket", "LeftRndPocketCuff", "RightRndPocketCuff"],
              },
              {
                label: "Heart Pockets",
                elements: ["HrtPcktLeft_00000011010503668109617630000000868876679039764388_", "HrtPcktRight"],
              },
      ...
      },
      {
        ...
        options: [
          ...
          { label: "Body", elements: ["JPBody_00000101805378233134778520000017316929125375769733_"] },
          {
            label: "Cuffs",
            elements: [
              "JPRightCuff_00000032641962985279224340000004127247677774557833_",
              "JPLeftCuff_00000131352480359154673870000016825018982183570593_",
            ],
          },
        ],
        extras: [
      ...
      },
      {
        ...
        options: [
          ...
          { label: "Body", elements: ["ESPBody_00000133498749950570912600000017972602896135310015_"] },
          {
            label: "Cuffs",
            elements: [
              "ESPRightCuff_00000164477731841545748660000013149076215441253562_",
              "ESPLeftCuff_00000147936418990615227040000001645997826541013888_",
            ],
          },
        ],
        extras: [
      ...
      },
      {
        ...
        options: [
          ...
          { label: "Body", elements: ["FPBody_00000009549735439879242760000008182166266484979363_"] },
          {
            label: "feet",
            elements: [
              "FPRightFoot_00000098180436191791874490000010773443282614185856_",
              "FPLeftFoot_00000143611989654149671010000017612352441603738782_",
            ],
          },
        ],
        extras: [
    ...
    variants: [
        ...
        extras: [
          {
            ...
            types: [
              ...
              {
                label: "Circle Pockets",
                elements: ["LeftCirPocket", "RightRndPocket", "LeftRndPocketCuff", "RightCirPocketCuff"],
              },
      ...
      },
      {
        ...
        options: [
          {
            label: "Waistband",
            elements: ["DigsWaist_00000005250936543746241200000000804603514933314467_"],
          },
          {
            label: "Cuff",
            elements: [
              "DigsLeftCuff_00000142176999847187206770000014688065766103618997_",
              "DigsRightCuff_00000117653865402338022560000001350464945375157653_",
            ],
          },
      ...
      },
      {
        ...
        options: [
          { label: "Waistband", elements: ["CECWaist_00000002374963185142003360000011353906822819844012_"] },
          {
            label: "Cuff",
            elements: [
              "CECLeftCuff_00000033337839485162087750000010040116480601795738_",
              "CECRightCuff_00000018231615366495583700000008791609602073274299_",
            ],
          },
    ...
    variants: [
      {
        ...
        options: [
          ...
          {
            label: "Side Body",
            elements: ["SheepyhugSweaterLeftSidePanel", "SheepyhugSweaterRightSidePanel"],
          },
        ...
        extras: [
          ...
          {
            label: "Add Pocket Cuffs",
            types: [{ label: "Kangaroo CuffS", elements: ["RPcktCuff", "LPcktCuff"] }],
          },
        ],
      },
      {
        ...
        extras: [
          {
            ...
            types: [
              ...
              {
                label: "Rounded flat",
                elements: ["RndFlatPcktR", "RndFlatPcktR_00000092445190267426784790000011558285010564762767_"],
              },
          ...
          { label: "Side Body", elements: ["QuarterSweaterLeftSidePanel", "QuarterSweaterRightSidePanel"] },
          {
            ...
            types: [
              ...
              { label: "Short Collar", elements: ["ShortCollar_00000130639884938210770930000008669500092146933134_"] },
              {
                label: "Hood",
                elements: [
                  "Hood_00000083805946112308332890000002891442673746281346_",
                  "HoodFill_00000003099604874630399990000015571489469321712034_",
                ],
              },
              {
                label: "Hood & Tall Collar",
                elements: [
                  "TallCollar_00000125573187673682285190000014496743265075223211_",
                  "Hood_00000083805946112308332890000002891442673746281346_",
                  "HoodFill_00000003099604874630399990000015571489469321712034_",
                ],
              },
              {
                label: "Hood & Short Collar",
                elements: [
                  "ShortCollar_00000130639884938210770930000008669500092146933134_",
                  "Hood_00000083805946112308332890000002891442673746281346_",
                  "HoodFill_00000003099604874630399990000015571489469321712034_",
                ],
              },
      ...
      },
      {
        ...
        options: [
          { label: "Body", elements: ["HalfZipSweaterBody_00000119838947203410075020000000538395446201435053_"] },
          {
            label: "Side Body",
            elements: [
              "HalfZipSweaterLeftSidePanel_00000134209921852998001010000016830497152334817684_",
              "HalfZipSweaterRightSidePanel_00000052785450975900319770000010404084037395891630_",
            ],
          },
          {
            label: "Neck",
            types: [
              ...
              { label: "Short Collar", elements: ["ShortCollar_00000160882779433284900430000012505166826721756806_"] },
              {
                label: "Hood",
                elements: [
                  "Hood_00000087391407447128084680000002775155269104432317_",
                  "HoodFill_00000044862054000031455020000009531068385004742056_",
                ],
              },
              {
                label: "Hood & Tall Collar",
                elements: [
                  "TallCollar_00000096781217521668280110000009125476678240014780_",
                  "Hood_00000087391407447128084680000002775155269104432317_",
                  "HoodFill_00000044862054000031455020000009531068385004742056_",
                ],
              },
              {
                label: "Hood & Short Collar",
                elements: [
                  "ShortCollar_00000160882779433284900430000012505166826721756806_",
                  "Hood_00000087391407447128084680000002775155269104432317_",
                  "HoodFill_00000044862054000031455020000009531068385004742056_",
                ],
              },
          ...
          },
          {
            label: "Sleeves",
            elements: [
              "HalfZipRightSleeve_00000049187548496325933920000005524563299710993035_",
              "HalfZipLeftSleeve_00000050662224817599592150000003610810620995548597_",
            ],
          },
          {
            label: "Sleeve Cuffs",
            elements: [
              "HalfZipRightCuff_00000083792517775903090720000004203456499086822837_",
              "HalfZipLeftCuff_00000178179389664677894240000007980141533104802446_",
            ],
          },
          {
            label: "Zipper",
            elements: ["HalfZip_00000155147293554217136010000007043751664322959791_"],
            colorSelector: "zipper",
          },
        ],
        extras: [
      ...
      },
      {
            ...
            types: [
              {
                label: "Hood",
                elements: [
                  "Hood_00000157994250730694846200000005983678880421254802_",
                  "HoodFill_00000142895482361448243120000008923250145134613120_",
                ],
              },
              ...
              { label: "Short Collar", elements: ["ShortCollar_00000063598696175291568490000011871263599672130994_"] },
              {
                label: "Hood & Tall Collar",
                elements: [
                  "TallCollar_00000170995999379726756140000011495366800018700452_",
                  "Hood_00000157994250730694846200000005983678880421254802_",
                  "HoodFill_00000142895482361448243120000008923250145134613120_",
                ],
              },
              {
                label: "Hood & Short Collar",
                elements: [
                  "ShortCollar_00000063598696175291568490000011871263599672130994_",
                  "Hood_00000157994250730694846200000005983678880421254802_",
                  "HoodFill_00000142895482361448243120000008923250145134613120_",
                ],
              },
        ...
        extras: [
          ...
          { label: "Add Pocket Cuffs", types: [{ label: "Kangaroo Cuffed", elements: ["RPcktCuff", "LPcktCuff"] }] },
        ],
      },
      {
        label: "Cardigan",
          ...
          { label: "Side Body", elements: ["CardiganSweaterLeftSidePanel", "CardiganSweaterRightSidePanel"] },
          {
            ...
            types: [
              ...
              { label: "Short Collar", elements: ["ShortCollar_00000147186300464306764600000012890538756985861268_"] },
              {
                label: "Hood",
                elements: [
                  "Hood_00000058552844475252033970000004537032376107617979_",
                  "HoodFill_00000180350995394164302220000014849385863992442812_",
                ],
              },
              {
                label: "Hood & Tall Collar",
                elements: [
                  "TallCollar_00000096740233782976255870000008197843053209280184_",
                  "Hood_00000058552844475252033970000004537032376107617979_",
                  "HoodFill_00000180350995394164302220000014849385863992442812_",
                ],
              },
              {
                label: "Hood & Short Collar",
                elements: [
                  "ShortCollar_00000147186300464306764600000012890538756985861268_",
                  "Hood_00000058552844475252033970000004537032376107617979_",
                  "HoodFill_00000180350995394164302220000014849385863992442812_",
                ],
              },
      ...
      },
      {
        ...
        options: [
          {
            label: "Body",
            elements: ["CampfireBody_00000170244581396509663830000003427713814946487442_"],
          },
          {
            label: "Side Body",
            elements: [
              "CampfireLeftSidePanel_00000093135057836102853010000012768035626530286759_",
              "CampfireRightSidePanel_00000040557372062079609460000016491289051611172284_",
            ],
          },
          {
            label: "Neck",
            elements: ["CampfireNeck_00000046310307428978349810000013612050494271288993_"],
          },
          {
            label: "Sleeves",
            elements: [
              "CampfireRightSleeve_00000069371634321454252050000010406483489980602006_",
              "CampfireLeftSleeve_00000139252793523566518900000017786704464211590293_",
            ],
          },
          {
            label: "Sleeve Cuffs",
            elements: [
              "CampfireRightCuff_00000065760145665194582450000009654923043154304412_",
              "CampfireLeftCuff_00000041283872498375009410000018326987088179655595_",
            ],
          },
        ],
        extras: [
        ...
        options: [
          {
            ...
            elements: [
              "VestChest",
              "VestLowerTorso_00000182497226486756089930000010016587736277426567_",
            ],
          },
          { label: "Side Body", elements: ["VestRightSidePanel", "VestLeftSidePanel"] },
          {
            ...
            types: [
              ...
              { label: "Short Collar", elements: ["ShortCollar_00000021085712356639165720000015774940922761103235_"] },
              {
                label: "Hood",
                elements: [
                  "Hood_00000047745864555876966430000014637321368015702681_",
                  "HoodFill_00000181773798462086411590000000549933047917184922_",
                ],
              },
              {
                label: "Hood & Tall Collar",
              ...
              },
              {
                label: "Hood & Short Collar",
                elements: [
                  "ShortCollar_00000021085712356639165720000015774940922761103235_",
                  "Hood_00000047745864555876966430000014637321368015702681_",
                  "HoodFill_00000181773798462086411590000000549933047917184922_",
                ],
              },
